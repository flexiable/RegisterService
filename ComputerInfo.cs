...
namespace RegService
{
    ...
    public class EncryptionHelper
    {
        ...
        {
            public static string ComputerInfofile = AppDomain.CurrentDomain.BaseDirectory+ "\\ComputerInfo.key";
            public static string RegistInfofile = AppDomain.CurrentDomain.BaseDirectory + "\\RegistInfo.key";
